...
import hw3
import heuristic_agent as agent_course
from copy import deepcopy
import time
#import sample_agent as agent_course
...
class Game:
    def __init__(self, a_map):
        self.ids = [hw3.ids, agent_course.ids]
    ...
    def play_game(self):
        ...
        self.agents = [self.initiate_agent(hw3, self.control_zone_1, 'first'),
                       self.initiate_agent(agent_course, self.control_zone_2, 'second')]
        self.play_episode()
        ...
        self.agents = [self.initiate_agent(hw3, self.control_zone_2, 'second'),
                       self.initiate_agent(agent_course, self.control_zone_1, 'first')]
...
def main():
    ...
    print(f'Score for {hw3.ids} is {results[0]}, score for {agent_course.ids} is {results[1]}')
